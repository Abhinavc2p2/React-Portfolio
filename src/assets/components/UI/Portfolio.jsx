...
const Portfolio = () => {
    ...
    useEffect(() => {
        ...
        if (selectTab === 'Mern-design') {
            const filteredData = data.filter(item => item.category === 'Mern')
            setPortfolios(filteredData);
        }
    }, [selectTab])
            ...
            <div className='container'>
                ...
                <div className='flex items-center justify-between flex-wrap'>
                    ...
                    ease-in duration-100 py-2 px-4 rounded-[8px]'>
                        ...
                        <button onClick={() => setSelectTab('Mern-design')} className='bg-smallTextColor bg-black text-white font-[500] gap-2 hover:bg-smallTextColor
                    ease-in duration-100 py-2 px-4 rounded-[8px]'>
                            MERN
                        </button>
                    </div>
